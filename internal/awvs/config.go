...
var ScanTypeMap = map[string]string{
	...
	"扫描SQL注入漏洞":      "11111111-1111-1111-1111-111111111115",
	"弱口令检测":          "11111111-1111-1111-1111-111111111117",
	"仅爬虫(可配合被动扫描)":   "11111111-1111-1111-1111-111111111119",
...
const (
	...
	SQLInjection  = "11111111-1111-1111-1111-111111111115" // SQL Injection
	WeakPasswords = "11111111-1111-1111-1111-111111111117" // Weak Passwords
	CrawlOnly     = "11111111-1111-1111-1111-111111111119" // Crawl Only
